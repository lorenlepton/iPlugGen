...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=iPlugGen Demo Installer\n"
      else:
        line="OutputBaseFilename=iPlugGen Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the iPlugGen Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the iPlugGen installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=iPlugGen Demo installer\n"
     else:
       line="SetupWindowTitle=iPlugGen installer\n"
